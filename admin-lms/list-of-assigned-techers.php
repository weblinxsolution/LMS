      ...
      <div class="content-body">
          ...
          <div class="row page-titles mx-0 mt-3">
              <div class="col">
                  <h4 class="card-title">Licst of Teachers's Students</h4>
              </div>
                          ...
                          <div class="card-body">
                              <div class="basic-form">
                                  ...
                                  <form>
                                      ...
                                      <button type="submit" class="btn btn-success text-white  d-block ml-auto">Assign Teacher</button>
                                  </form>
                                  <div class="table-responsive mt-3">
                                      <table class="table  ">
                                          <thead>
                                              <tr>
                                                  <th><input type="checkbox" value="All" checked></th>
                                                  <th>Image</th>
                                                  <th>Name</th>
                                                  <th>Email</th>
                                                  <th>Number</th>
                                          ...
                                          <tbody>
                                              <tr>
                                                  <td><input type="checkbox" value="All" checked></td>
                                                  <td>
