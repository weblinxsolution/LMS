      ...
      <div class="content-body">
          ...
          <div class="row page-titles mx-0 mt-3">
              <div class="col">
                  <h4 class="card-title">Teachers Profile</h4>
              </div>
              <div class="col p-md-0">
                  <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a href="javascript:void(0)">Teachers Managements</a></li>
                      <li class="breadcrumb-item active"><a href="javascript:void(0)">Teacher Profile</a></li>
                  </ol>
              </div>
          </div>
          <!-- row -->
                                          ...
                                          <div class="row">
                                              <div class="col-lg-4 pt-3">
                                                  <ul class="std-details">
                                                      <li><span class="font-weight-bold">Teacher Name:</span><span>John Doe</span></li>
                                              ...
                                              <div class="col-lg-4 pt-3">
                                                  <ul class="std-details">
                                                      <li><span class="font-weight-bold">Status:</span><span class="badge badge-success text-white rounded-pill">Active</span></li>
